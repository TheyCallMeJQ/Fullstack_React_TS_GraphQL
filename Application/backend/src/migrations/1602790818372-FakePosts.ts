...
export class FakePosts1602790818372 implements MigrationInterface {
  public async up(_queryRunner: QueryRunner): Promise<void> {
    // queryRunner.query(
    //   `insert into post ("creatorId", "title", "text", "createdAt") values (1, 'Jumpin'' Jack Flash', 'Etiam vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida sem.', '2020-03-31T18:05:42Z');
